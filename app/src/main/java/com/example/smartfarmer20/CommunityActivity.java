...
import static com.example.smartfarmer20.SignUpActivity.PReqCode;
import static com.example.smartfarmer20.SignUpActivity.REQUESCODE;
...
public class CommunityActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // toolbar=findViewById(R.id.toolbarId);
        fab_btn=findViewById(R.id.fabId);
